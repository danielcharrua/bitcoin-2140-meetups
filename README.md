<p align="center"><img src="./art/repo-header.png" alt="2140 header"></p>
...
Mi experiencia viene de organizar meetups como la de WordPress Coruña, donde tenemos una charla una vez al mes y luego un networking en algún bar cercano. Las charlas son súper importante pero más aún es el networking, donde conoces gente, haces contactos profesionales, intercambias sats, etc.

## Equipo organizador
Es importante designar un equipo organizador (2-4 personas) que tenga disponibilidad y sea responsable. Este equipo debe realizar varias tareas previas y posteriores a cada meetup para que el evento sea una buena experiencia para todos. Si algun integrante del equipo falla, son los otros quienes deben hacer su trabajo, por lo tanto es importante el compromiso y la dedicación en los integrantes del equipo organizador.

Al monento de crear el equipo sería interesante ver las aptitudes de cada uno y dividir taras generales. Algunas son:
...
Es importante que el grupo tenga algunos followers/interesados para que cuando publiquemos el evento ya sean informados automaticamente.

## Patrocinadores
Es importante contar con patrocinadores (siempre que sea posible) para que ayude a montar el evento. Los patrocinadores pueden ser entidades que nos brinden el sitio para celebrar la meetup, bares que cedan espacio para networking, un fotógrafo y algo que considero fundamental, un patrocinador para pinchos y cañas.
...
Es una buena práctica que agradezcas a los patrocinadores con diapositivas al inicial el evento y darles la posibilidad de poner un banner siempre bajo tus condiciones.
...
La frecuencia de las meetups sería de 1 vez al mes. Si alguno se anima a dos veces puede intentarlo pero hay que tener en cuenta que el trabajo de organización se duplica.

Se pueden alternar charlas standard con otras tipo talleres prácticos. Si se hacen talleres prácticos donde involucre el uso de ordenadores por parte de los participantes eso debe avisarse, y tener en cuenta que seguramente necesiten acceso a una red Wi-Fi y a la red eléctrica.
...
Idea: si cuentas con algun patrocinador que te deje algo para regalar a los asistentes, puedes hacer un kahoot al finalizar la charla. Esto motiva bastante a los asistentes.

## Networking
El networking siempre hazlo de pie, nunca sentados. Esto permite a los participantes moverse e interactuar entre todos. Ten en cuenta esto al reservar el sitio para el networking y siempre avisa con tiempo al bar que quieres mesas o sitio para estar de pié.

Si cuentas con un patrocinador que te pague pinchos y cañas lo puedes resolver con unos tickets a cada integrante y que mediante ellos obtengan la consumición. Normalmente en ciudades pequeñas la afluencia no es tanta por lo que se hace más fácil gestionar este tipo de cosas, en Coruña no solemos usar tickets que nos conocemos todos ;)

Si no hay patrocinador, pues cada uno puede pagar su consumición y tú como organizador (si cuentas con fondos o donaciones) llevar comida (siempre que el sitio te lo permita).

## Ponentes
Todos los meses se deberá hacer una selección y llamada a ponentes para las charlas. Esto significa ponerse en contacto con los ponentes, comentarles como funciona la meetup y darles apoyo.

Es interesante que el equipo organizador siempre tenga un listado de posibles ponentes e ideas. En el caso de que no se consiga ponente para ese mes, uno de los organizadores puede dar un taller práctico o charla como "fallback".
...
* Tienen que estar 20 minutos antes el día de la meetup para hacer una pequeña prueba de los equipos.
* La duración de la charla será de máximo 45 minutos y 15 minutos de preguntas si se desea.
* Si la presentación se hace en TV no incluir textos pequeños
...
Una vez hayas publicado el evento, automaticamente se informará a todos los participantes del grupo con un email (enviado por meetup.com).
...
* Webs relacionadas, ponerse en contacto
...
Esto dependerá de tus recursos, el sitio donde hagas el evento y la cantidad de gente que esperas. Si tienes un sitio con mucho ruido igual necesitas un micro, una pequeña consola y un altavoz con amplificador pero dependerá tambien si te lo permiten.
